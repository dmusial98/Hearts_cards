...
namespace HeartsServer.GameLogic.Tests.Writers.Tests.ILogWriter.Tests
{
    public class LogWriterTestBase
    {
        public async Task<string> WriteUserConnected_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.USER_CONNECTED_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id, " connected with server\r\n");
        }
        ...
        public async Task<string> WriteUserClickedStartGame_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.USER_CLICKED_START_CONST, " ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id, " clicked start game\r\n");
        }
        ...
        public async Task<string> WriteStartGame_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.GAME_STARTED_CODE_CONST, " ", DateTime.Now.ToString("G"), ": Game started\r\n");
        }
        ...
        public async Task<string> WritePlayersGotCards_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            for (int i = 0; i < Consts.PLAYERS_NUMBER_CONST; i++)
            {
                output.Append(String.Concat(Consts.PLAYERS_GOT_CARDS_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", players[i].Name, ", ID: ", players[i].Id, " got cards: "));
        ...
        public async Task<string> WritePlayerGaveCardsExchange_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.PLAYER_GAVE_CARDS_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", playerFrom.Name, ", ID: ", playerFrom.Id, " gave cards ", cardsStr, " for exchange to ", playerTo.Name, ", ID: ", playerTo.Id, "\r\n");
        }
        ...
        public async Task<string> WritePlayerReceivedCardsExchange_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.PLAYER_RECEIVED_CARDS_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", playerFrom.Name, ", ID: ", playerFrom.Id, " received cards ", cardsStr, " for exchange from ", playerTo.Name, ", ID: ", playerTo.Id, "\r\n");
        }
        ...
        public async Task<string> WritePlayerThrewCard_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.PLAYER_THREW_CARD_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id.ToString(), " threw card ", card.ToString(), "\r\n");
        }
        ...
        public async Task<string> WriteTrick_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.TRICK_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", playerWhoWonTrick.Name, ", ID: ", playerWhoWonTrick.Id.ToString(), " won trick, began " + playerWhoStarted.Name + ", ID: " + playerWhoStarted.Id +" cards: ", cardsStr.ToString(), "\r\n");
        }
        ...
        public async Task<string> WritePlayersPointsInRound_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            foreach (Player player in players)
                output.Append(String.Concat(Consts.PLAYERS_POINTS_IN_ROUND_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player's ", player.Name, ", ID: ", player.Id.ToString(), " points in that round (", roundNumber.ToString(), "): ", player.PointsInRound, "\r\n"));
        ...
        public async Task<string> WritePlayersPointsAfterRound_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            StringBuilder output = new();
            foreach (Player player in players)
                output.Append(String.Concat(Consts.PLAYERS_POINTS_AFTER_ROUND_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player's ", player.Name, ", ID: ", player.Id.ToString(), " points after that round (", roundNumber, "): ", player.Points, "\r\n"));
        ...
        public async Task<string> WritePlayersPlacesAfterGame_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            StringBuilder output = new();
            foreach (Player player in players)
                output.Append(String.Concat(Consts.PLAYERS_PLACES_AFTER_GAME_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player's ", player.Name, ", ID: ", player.Id.ToString(), " place in game: ", player.Place, "\r\n"));
        ...
        public async Task<string> WritePlayersCards_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            foreach (Player player in players)
            {
                ...
                output.Append(String.Concat(Consts.PLAYERS_CARDS_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player's ", player.Name, ", ID: ", player.Id.ToString(), " cards: ", cardsStr.ToString(), "\r\n"));
            }
        ...
        public async Task<string> WriteClientSendMessage_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.USER_SEND_MESSAGE_CODE_CONST, " ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id.ToString(), " send message: ", message, "\r\n");
        }
        ...
        public async Task<string> WriteRoundStarted_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat(Consts.ROUND_STARTED_CODE_CONST, " ", DateTime.Now.ToString("G"), ": Round ", roundNumber.ToString(), " started", "\r\n");
        }
