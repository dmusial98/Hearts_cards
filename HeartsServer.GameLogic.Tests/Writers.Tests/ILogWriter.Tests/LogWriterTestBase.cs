...
namespace HeartsServer.GameLogic.Tests.Writers.Tests.ILogWriter.Tests
{
    public class LogWriterTestBase
    {
        public async Task<string> WriteUserConnected_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C1 ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id, " connected with server\r\n");
        }
        ...
        public async Task<string> WriteUserClickedStartGame_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C2 ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id, " clicked start game\r\n");
        }
        ...
        public async Task<string> WriteStartGame_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C3 ", DateTime.Now.ToString("G"), ": Game started\r\n");
        }
        ...
        public async Task<string> WritePlayerGaveCardsExchange_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C5 ", DateTime.Now.ToString("G"), ":  player ", playerFrom.Name, ", ID: ", playerFrom.Id, " gave cards ", cardsStr, " for exchange to ", playerTo.Name, ", ID: ", playerTo.Id, "\r\n");
        }
        ...
        public async Task<string> WritePlayerReceivedCardsExchange_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C6 ", DateTime.Now.ToString("G"), ":  player ", playerFrom.Name, ", ID: ", playerFrom.Id, " received cards ", cardsStr, " for exchange from ", playerTo.Name, ", ID: ", playerTo.Id, "\r\n");
        }
        ...
        public async Task<string> WritePlayerThrewCard_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C7 ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id.ToString(), " threw card ", card.ToString(), "\r\n");
        }
        ...
        public async Task<string> WriteTrick_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C8 ", DateTime.Now.ToString("G"), ":  player ", playerWhoWonTrick.Name, ", ID: ", playerWhoWonTrick.Id.ToString(), " won trick with cards: ", cardsStr.ToString(), "\r\n");
        }
        ...
        public async Task<string> WritePlayersPointsInRound_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            foreach (Player player in players)
                output.Append(String.Concat("C9 ", DateTime.Now.ToString("G"), ":  player's ", player.Name, ", ID: ", player.Id.ToString(), " points in that round (", roundNumber.ToString(), "): ", player.PointsInRound, "\r\n"));
        ...
        public async Task<string> WriteClientSendMessage_BaseTest(Hearts_server.ResultsWriter.ILogWriter writer)
        {
            ...
            return String.Concat("C13 ", DateTime.Now.ToString("G"), ":  player ", player.Name, ", ID: ", player.Id.ToString(), " send message: ", message, "\r\n");
        }
